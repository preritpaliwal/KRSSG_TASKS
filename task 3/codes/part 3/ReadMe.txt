...
2)controller.cpp (it gets the path and controls the turtle simulation to move on that path while avoiding daenerys (AKA other turtle))
...
1)open 5 terminal windows
   ...
   -> rosrun daenerys feedback.py (image window should come up)
   -> rosrun daenerys controller
   -> rosrun daenerys path.py (another image window should come up)
